...
function Header() {
    ...
    return (
        ...
        <div className="mainDiv">
            ...
            <div className="time">
                <Link to='/cardano'><div style={{color:'white', margin:'10px'}}>24H</div></Link>
                <Link to='/adaweek'><div style={{color:'white', margin:'10px'}}>1W</div></Link>
                <Link to='/adayear'><div style={{color:'white', margin:'10px'}}>1Y</div></Link>
            </div>
