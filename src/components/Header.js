...
function Header() {
    ...
    return (
        ...
        <div className="mainDiv">
            ...
            <div className="time">
                <Link to='/'><div style={{color:'white', margin:'10px'}}>24H</div></Link>
                <Link to='/ethweek'><div style={{color:'white', margin:'10px'}}>1W</div></Link>
                <Link to='/ethyear'><div style={{color:'white', margin:'10px'}}>1Y</div></Link>
            </div>
